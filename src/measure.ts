...
/**
 * Тарифы из макетов: цена за месяц, сколько глав в квоте и во сколько глав
 * квоты обходится кнопка «перевести получше».
 *
 * Множитель на «Запойном» был двойкой и оказался убыточным, пока на кнопке
 * стоял Opus: 7.93 ₽ выручки против 14.58 ₽ себестоимости. С Sonnet двойка
 * выходит в плюс, но на 27% — вдвое тоньше, чем тройка на «Читателе», и
 * тоньше именно у того читателя, который жмёт эту кнопку чаще всех. Тройка
 * на обоих тарифах: 61% и 52%, и одно правило вместо двух.
 */
const PLANS = [
